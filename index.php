			...
			<div class= "row w-100 d-flex justify-content-center align-items-center" style="height:90vh">
				<div class="col-sm-4">
					<div class="d-flex align-items-center" style="height:100px">
						<a class="button4" style="background-color:#f14e4e" href="100monos/videos.php?lang=ESP"><span class="flag-icon flag-icon-es"></span> Árbol genealógico</a>
					</div>
					<div class="d-flex align-items-center justify-content-end" style="height:100px">
						<a class="button4" style="background-color:#f1bb4e; color: black;" href="100monos/videos.php?lang=ITA"><span class="flag-icon flag-icon-it"></span> L`Albero Genealógico</a>
					</div>
					<!-- <div class="d-flex align-items-center" style="height:100px">
				...
				<div class="col-sm-4 d-flex flex-column justify-content-center p-0">
					<div class="d-flex align-items-center justify-content-center" style="height:100px">
						<a class="button4" style="background-color:#84f14e; color: black;" href="100monos/videos.php?lang=POR"><span class="flag-icon flag-icon-pt"></span> Árvore Genealógica</a>
					</div>
				...
				<div class="col-sm-4">
					<div class="d-flex align-items-center justify-content-end" style="height:100px">
						<a class="button4" style="background-color:#4ef18f; color: black;" href="100monos/videos.php?lang=ING"><span class="flag-icon flag-icon-gb"></span> Family Tree</a>
					</div>
					<div class="d-flex align-items-center" style="height:100px">
						<a class="button4" style="background-color:#4e9af1" href="100monos/videos.php?lang=FRA"><span class="flag-icon flag-icon-fr"></span> L'arbre généalogique</a>
					</div>
					<!-- <div class="d-flex align-items-center justify-content-end" style="height:100px">
