		...
		<div class= "row">
			<div class="col-sm-4">
				<div class="d-flex align-items-center" style="height:100px">
					<a class="button4" style="background-color:#f14e4e" href="Bienve_cast.htm"><span class="flag-icon flag-icon-es"></span> Árbol genealógico de los Dri</a>
				</div>
				<div class="d-flex align-items-center justify-content-end" style="height:100px">
					<a class="button4" style="background-color:#f1bb4e" href="benvenuti.htm"><span class="flag-icon flag-icon-it"></span> L` Albero Genealógico dei Dri</a>
				</div>
				<div class="d-flex align-items-center" style="height:100px">
					<a class="button4" style="background-color:#84f14e" href="Benvindos.htm"><span class="flag-icon flag-icon-pt"></span> Árvore Genealógica dos Dri</a>
				</div>
			</div>
			...
			<div class="col-sm-4">
				<div class="d-flex align-items-center justify-content-end" style="height:100px">
					<a class="button4" style="background-color:#4ef18f" href="WELCOME.HTM"><span class="flag-icon flag-icon-gb"></span> Family Tree of the surname Dri</a>
				</div>
				<div class="d-flex align-items-center" style="height:100px">
					<a class="button4" style="background-color:#4e9af1" href="WELCOME.HTM"><span class="flag-icon flag-icon-fr"></span> L 'arbre généalogique de la famille Dri</a>
				</div>
				<div class="d-flex align-items-center justify-content-end" style="height:100px">
